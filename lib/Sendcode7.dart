...
import 'package:project1/Sendcode8.dart';

import 'Enter4.dart';

class Sendcode7 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Password Recovery",style: TextStyle(color: Colors.blue)),
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              child: Text('Next'),
                              onPressed: () {
                                Route route = MaterialPageRoute(builder: (context) => Sendcode8());
                                Navigator.pushReplacement(context, route);
                              },
                              style: ButtonStyle(
...
const String _svg_rotfw =
    '<svg viewBox="14.5 351.5 347.0 1.0" ><path transform="translate(14.5, 351.5)" d="M 0 0 L 347 0" fill="none" stroke="#273348" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
