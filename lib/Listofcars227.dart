...
import 'package:project1/Listofcars221.dart';

class Listofcars227 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            Route route = MaterialPageRoute(builder: (context) => Listofcars221());
            Navigator.pushReplacement(context, route);
          },
        ),
        title: Text("Completed Orders",style: TextStyle(color: Colors.blue),),
...
const String _svg_ybekz1 =
    '<svg viewBox="27.5 311.5 328.0 1.0" ><path transform="translate(27.5, 311.5)" d="M 0 0 L 328 0" fill="none" stroke="#eaeaea" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_xxob7 =
    '<svg viewBox="27.5 373.5 328.0 1.0" ><path transform="translate(27.5, 373.5)" d="M 0 0 L 328 0" fill="none" stroke="#eaeaea" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_xx7yz7 =
    '<svg viewBox="27.5 434.5 328.0 1.0" ><path transform="translate(27.5, 434.5)" d="M 0 0 L 328 0" fill="none" stroke="#eaeaea" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_o4nc8d =
    '<svg viewBox="27.5 494.5 328.0 1.0" ><path transform="translate(27.5, 494.5)" d="M 0 0 L 328 0" fill="none" stroke="#eaeaea" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_f0swb7 =
    '<svg viewBox="27.5 620.5 328.0 1.0" ><path transform="translate(27.5, 620.5)" d="M 0 0 L 328 0" fill="none" stroke="#eaeaea" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_o9btrh =
    '<svg viewBox="27.5 558.5 328.0 1.0" ><path transform="translate(27.5, 558.5)" d="M 0 0 L 328 0" fill="none" stroke="#eaeaea" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_hnbh18 =
    '<svg viewBox="2.2 4.2 10.6 8.2" ><path transform="translate(0.0, 0.0)" d="M 6.254638671875 12.25517749786377 C 6.15372371673584 12.35663318634033 6.016111373901367 12.41329669952393 5.873103618621826 12.41329669952393 C 5.730094909667969 12.41329669952393 5.592482566833496 12.35663318634033 5.491567611694336 12.25517749786377 L 2.44467830657959 9.207749366760254 C 2.128441095352173 8.891511917114258 2.128441095352173 8.378840446472168 2.44467830657959 8.063141822814941 L 2.82621431350708 7.681605815887451 C 3.142451763153076 7.365368366241455 3.654584169387817 7.365368366241455 3.970821619033813 7.681605815887451 L 5.873103618621826 9.583889007568359 L 11.01331233978271 4.443679809570312 C 11.32955074310303 4.127441883087158 11.84222221374512 4.127441883087158 12.15791988372803 4.443679809570312 L 12.53945636749268 4.825215339660645 C 12.85569381713867 5.141453266143799 12.85569381713867 5.65412425994873 12.53945636749268 5.969822883605957 L 6.254638671875 12.25517749786377 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
